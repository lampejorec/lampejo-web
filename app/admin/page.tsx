...
import { 
  LayoutDashboard, FileText, PieChart as PieIcon, Settings, Plus, 
  Trash2, Printer, Save, CheckCircle, XCircle, 
  ArrowUpRight, ArrowDownRight, DollarSign, Calendar, 
  ChevronLeft, ChevronRight, Filter, LogOut, Lock, Users, Globe, Briefcase, Link, MessageSquare, Upload, Star, Scale, FileCheck, BarChart3, TrendingUp, Camera, Box, Database
} from "lucide-react";
import { 
...
function PropostasView({ propostas, clientes, refresh, session, onPrint }: any) {
    ...
    return (
      <div className="space-y-6 text-white text-white font-white font-white font-white font-white font-white"><div className="flex justify-between items-center font-white text-white font-white font-white font-white font-white font-white font-white font-white font-white font-white font-white font-white"><h1 className="text-4xl font-black tracking-tighter uppercase font-white text-white font-white font-white font-white font-white font-white font-white font-white font-white font-white font-white font-white">Propostas</h1><button onClick={() => setEditing({id:'new', cliente:'', projeto:'', introducao:'', entregaveis:'', itens:[], status:'rascunho', data: new Date().toISOString().slice(0, 10)})} className="bg-white text-black px-8 py-4 rounded-3xl font-black flex items-center gap-2 transition-all uppercase text-[10px] active:scale-95 shadow-xl shadow-white/5 active:bg-neutral-200">Nova Proposta</button></div>
